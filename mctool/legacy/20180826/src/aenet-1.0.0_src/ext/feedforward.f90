...
contains !-------------------------------------------------------------!
  ...
  subroutine ff_print_info(net, verbose)
    ...
    do ilayer = 2, net%nlayers
       select case(net%f_a(ilayer))     !!!jhyang!!! print network information 
       case(0)
       ...
       case(6) !!!jhyang!!!
          fname = 'exponential linear unit (elu)'
       end select
  ...
  subroutine ff_change_activation(net, ilayer, ftype)
    ...
    select case(ftype)  !!!jhyang!!! network indexing
    case('linear','l')
       net%f_a(ilayer) = 0
    case('tanh','t')
       net%f_a(ilayer) = 1
    ...
    case('twist','w')
       net%f_a(ilayer) = 4
    case('relu','r')
       net%f_a(ilayer) = 5  !!!jhyang!!! ReLU 
    case('elu','e')
       net%f_a(ilayer) = 6  !!!jhyang!!! ELU
    case default
  ...
  elemental subroutine ff_activate(t, x, y, dy) !!!jhyang!!! activation function
    ...
    double precision, parameter :: d = 1d0      !!!jhyang!!! 
