...
module input
  ...
  type, public :: InputData
     ...
     integer                                             :: trn_ntestset !!jhyang!!
     logical                                             :: trn_readtest !!jhyang!!
...
contains
  ...
  subroutine inp_defaults(inp)
    ...
    inp%trn_readtest     = .false.  !!jhyang!!
    inp%trn_ntestset     = 0        !!jhyang!!
  ...
  function read_InpTrain(file) result(inp)
    ...
    call inp_read_value(u, 'testingset',    inp%trn_ntestset)  !!jhyang!!
    if (inp%trn_ntestset .ne. 0) inp%trn_readtest = .true. !!jhyang!!
